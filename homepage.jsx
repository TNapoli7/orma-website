...
function LoadingScreen() {
  ...
  return (
    ...
    >
      <div className="orma-logo-reveal">
        <svg width="108" height="94" viewBox="0 0 151 131" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Orma">
  ...
  return (
    <footer id="footer" data-screen-label="09 Footer" style={{
      ...
      <div style={{
        ...
        <svg viewBox="0 0 580 130" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto' }}>
          <path d="M102.444 33.695C98.369 24.045 92.337 16.022 84.349 9.616 76.374 3.209 66.301 0 54.156 0c-.609 0-1.206.012-1.792.035-.363 0-.726-.035-1.089-.035C42.772 0 35.358 1.85 29.011 5.563 22.663 9.276 17.404 14.148 13.223 20.191 11.08 23.283 9.217 26.586 7.601 30.111c-.574 1.171-1.113 2.366-1.616 3.584C1.991 43.346 0 53.828 0 65.142s1.991 21.796 5.985 31.446c3.994 9.651 10.025 17.685 18.095 24.08 8.069 6.406 18.095 9.604 30.076 9.604s20.007-3.198 28.076-9.604c8.07-6.406 14.101-14.429 18.095-24.08 3.994-9.65 6.032-20.132 6.114-31.446.082-11.314-1.909-21.796-5.985-31.446h-.012zM41.8 116.428c-5.411-5.903-9.78-13.304-13.106-22.206-3.326-8.901-5.575-18.552-6.734-28.952-1.171-10.4-1.043-20.051.374-28.952 1.417-8.901 4.205-16.303 8.362-22.206 4.064-5.774 9.557-8.714 16.491-8.843-5.165 2.038-9.557 5.891-13.141 11.618-3.83 6.102-5.739 14.359-5.739 24.759 0 7.66.96 14.113 2.869 19.384 1.909 5.27 4.334 9.51 7.273 12.742 2.928 3.233 6.067 5.563 9.417 7.004 3.35 1.441 6.465 2.155 9.334 2.155 2.87 0 5.048-.597 6.911-1.792 1.851-1.195 2.776-2.811 2.776-4.849 0-2.986-.843-5.387-2.506-7.179-1.675-1.792-3.772-3.315-6.278-4.58-2.506-1.253-5.235-2.424-8.163-3.502-2.928-1.077-5.657-2.483-8.163-4.216-2.507-1.734-4.603-3.97-6.278-6.734-1.675-2.753-2.518-6.336-2.518-10.764 0-9.451 1.792-16.713 5.388-21.808C41.952 12.426 46.379 9.885 51.65 9.885c2.752 0 5.657.808 8.702 2.424 3.057 1.616 6.008 4.123 8.878 7.543 2.869 3.408 5.587 7.741 8.163 13.012 2.495 5.106 4.673 11.115 6.547 18.013.954 4.638 1.862 9.428 2.424 14.406.105.937.187 1.862.269 2.787.234 2.987.363 5.997.363 9.03 0 8.679-1.054 16.514-3.139 23.505-2.096 7.004-5.27 12.708-9.51 17.135-4.251 4.427-9.721 6.641-16.42 6.641-1.944 0-3.818-.211-5.634-.574-3.795-1.429-7.285-3.877-10.471-7.355l-.023-.024z" fill={C.bege}/>
          <path d="M137.276 96.834c4.321 0 7.612 1.745 9.861 5.235 2.249 3.49 3.373 7.285 3.373 11.361s-1.124 7.858-3.373 11.36c-2.249 3.491-5.528 5.236-9.861 5.236-4.334 0-7.578-1.745-9.733-5.236-2.167-3.49-3.244-7.273-3.244-11.36s1.077-7.859 3.244-11.361c2.155-3.49 5.399-5.235 9.733-5.235z" fill={C.bege}/>
          <text x="160" y="118" fill={C.bege} fontFamily="'General Sans', sans-serif" fontWeight="700" fontSize="128" letterSpacing="-0.04em">rma.</text>
        </svg>
      </div>
