...
// ============================================================
// Tree watermark — inline SVG for crisp rendering at any size
// ============================================================
function TreeMark({ opacity = 0.08, fill = C.ink, style = {} }) {
  return (
    <div style={{
      display: 'flex',
      alignItems: 'center',
  ...
  return (
    <section data-screen-label="01 Hero" style={{
      ...
      <div style={{ position: 'absolute', right: -120, bottom: -80, width: 600, height: 600, pointerEvents: 'none', zIndex: 1 }}>
        <TreeMark opacity={0.08} fill="#FFFFFF" />
      </div>
    ...
    <section ref={sectionRef} data-screen-label="03 Pillars" style={{
      ...
      <div style={{
        ...
        <div ref={bgTreeRef} style={{
          ...
          <TreeMark opacity={0.15} fill="#5C6457" />
        </div>
      </div>
