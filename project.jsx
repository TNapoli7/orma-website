...
const ACABAMENTOS_ROOMS = [
  {
    ...
    image: './bathroom.jpg',
    spots: [
      { id: 'ceiling', x: 48, y: 6, label: 'Teto', material: 'Gesso cartonado RAL 9010', detail: 'Teto falso em gesso cartonado branco puro. Planos limpos que recuam para que a luz e a forma conduzam o espaço.' },
      { id: 'shower', x: 76, y: 16, label: 'Duche', material: 'BRUMA — Sistema embutido', detail: 'Sistema de duche embutido BRUMA com chuveiro de parede e douchette. Válvulas ocultas mantêm a parede contínua.', url: 'https://www.bruma.pt/assets/INFO/new/1673602CR_ficha.pdf' },
      { id: 'mirror', x: 32, y: 28, label: 'Espelho', material: 'ITALBOX — Retroiluminado', detail: 'Espelho redondo ITALBOX com halo LED integrado. Iluminação ambiente suave a enquadrar o reflexo.', url: 'https://italbox.pt/pt/produtos/espelhos/espelhos-com-iluminacao/redondo-' },
      { id: 'faucet', x: 30, y: 56, label: 'Torneira', material: 'BRUMA — Aço inox escovado', detail: 'Torneira monocomando de lavatório BRUMA em aço inox escovado anti-impressões digitais. Design minimalista com controlo de temperatura integrado.', url: 'https://www.bruma.pt/?page=products&prod=4596' },
      { id: 'basin', x: 28, y: 63, label: 'Lavatório', material: 'ITALBOX — Solid surface', detail: 'Lavatório ITALBOX Quadratum em solid surface. Geometria precisa, quente ao toque, não poroso e fácil de manter.', url: 'https://italbox.pt/pt/produtos/lavatorios/solid-surface-1/bancada-lavatorio-quadratum-ss' },
      { id: 'vanity', x: 32, y: 83, label: 'Móvel', material: 'ITALBOX — Folheado a carvalho', detail: 'Móvel de lavatório suspenso ITALBOX em folheado de carvalho. O veio natural aquece a pedra e a cerâmica envolventes.' },
      { id: 'wc', x: 55, y: 82, label: 'Sanita', material: 'GEBERIT — Suspensa', detail: 'Conjunto sanita suspensa GEBERIT com autoclismo oculto e comando de descarga. O chão fica livre para fácil limpeza.', url: 'https://catalog.geberit.pt/pt-PT/product/PRO_1511968' },
      { id: 'tile', x: 58, y: 94, label: 'Cerâmico', material: 'MARAZZI — Grande Concrete Look White', detail: 'Cerâmico MARAZZI Grande Concrete Look White em paredes e pavimento. Placas de grande formato que minimizam juntas.', url: 'https://www.marazzitile.co.uk/collections/grande-concrete-look-collections/' },
    ],
  },
  {
    id: 'cozinha',
    ...
    image: './kitchen.png',
    spots: [
      { id: 'ceiling', x: 33, y: 5, label: 'Teto', material: 'Gesso cartonado RAL 9010', detail: 'Teto falso em gesso cartonado branco puro. Um fundo silencioso para a marcenaria e a pedra.' },
      { id: 'cab-upper', x: 68, y: 22, label: 'Armários superiores', material: 'ONESKIN — Tortora', detail: 'Revestimento ONESKIN cor Tortora nos armários superiores — um taupe suave e quente. Textura mate que difunde a luz e resiste a impressões digitais.', url: 'https://www.oneskin.pt/products_sub/tortora-1' },
      { id: 'backsplash', x: 58, y: 37, label: 'Backsplash', material: 'COSENTINO — Dekton Keena', detail: 'Backsplash em composto dekton COSENTINO, referência Keena. Resistente ao calor, manchas e riscos.', url: 'https://www.cosentino.com/pt-pt/cores/dekton/keena/' },
      { id: 'faucet', x: 64, y: 44, label: 'Torneira', material: 'BRUMA — Cromada', detail: 'Torneira monocomando de lava-loiça BRUMA com bica alta giratória. Cartucho cerâmico para controlo preciso de caudal e temperatura.', url: 'https://www.bruma.pt/?page=products&prod=6625' },
      { id: 'countertop', x: 48, y: 49, label: 'Tampo', material: 'COSENTINO — Dekton Keena', detail: 'Tampo igual ao backsplash. Um material, uma superfície contínua do horizontal ao vertical.', url: 'https://www.cosentino.com/pt-pt/cores/dekton/keena/' },
      { id: 'cab-lower', x: 65, y: 60, label: 'Armários inferiores', material: 'ONESKIN — Sunny White', detail: 'Revestimento ONESKIN cor Sunny White nos armários inferiores. Um branco suave e quente que reflete a luz natural sem parecer clínico.', url: 'https://www.oneskin.pt/products_sub/sunny-white' },
      { id: 'flooring', x: 25, y: 88, label: 'Pavimento', material: 'Madeira de pinho — Contra-fiado', detail: 'Pavimento em madeira de pinho com aplicação contra-fiado. Comprimentos aleatórios que acrescentam ritmo e calor ao espaço.' },
    ],
  },
];
