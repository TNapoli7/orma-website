...
const ACABAMENTOS_ROOMS = [
  {
    ...
    spots: [
      ...
      { id: 'mirror', x: 44, y: 30, label: 'Espelho', material: 'ITALBOX — Retroiluminado', detail: 'Espelho redondo ITALBOX com halo LED integrado. Iluminação ambiente suave a enquadrar o reflexo.', url: 'https://italbox.pt/pt/produtos/espelhos/espelhos-com-iluminacao/redondo-' },
      { id: 'faucet', x: 34, y: 43, label: 'Torneira', material: 'BRUMA — Aço inox escovado', detail: 'Torneira monocomando de lavatório BRUMA em aço inox escovado anti-impressões digitais. Design minimalista com controlo de temperatura integrado.', url: 'https://www.bruma.pt/?page=products&prod=4596' },
      { id: 'basin', x: 33, y: 49, label: 'Lavatório', material: 'ITALBOX — Solid surface', detail: 'Lavatório ITALBOX Quadratum em solid surface. Geometria precisa, quente ao toque, não poroso e fácil de manter.', url: 'https://italbox.pt/pt/produtos/lavatorios/solid-surface-1/bancada-lavatorio-quadratum-ss' },
      { id: 'vanity', x: 28, y: 59, label: 'Móvel', material: 'ITALBOX — Folheado a carvalho', detail: 'Móvel de lavatório suspenso ITALBOX em folheado de carvalho. O veio natural aquece a pedra e a cerâmica envolventes.' },
