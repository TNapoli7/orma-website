...
const ACABAMENTOS_ROOMS = [
  {
    ...
    spots: [
      ...
      { id: 'faucet', x: 33, y: 55, label: 'Torneira', material: 'BRUMA — Aço inox escovado', detail: 'Torneira monocomando de lavatório BRUMA em aço inox escovado anti-impressões digitais. Design minimalista com controlo de temperatura integrado.', url: 'https://www.bruma.pt/?page=products&prod=4596' },
      { id: 'basin', x: 32, y: 62, label: 'Lavatório', material: 'ITALBOX — Solid surface', detail: 'Lavatório ITALBOX Quadratum em solid surface. Geometria precisa, quente ao toque, não poroso e fácil de manter.', url: 'https://italbox.pt/pt/produtos/lavatorios/solid-surface-1/bancada-lavatorio-quadratum-ss' },
      { id: 'vanity', x: 30, y: 72, label: 'Móvel', material: 'ITALBOX — Folheado a carvalho', detail: 'Móvel de lavatório suspenso ITALBOX em folheado de carvalho. O veio natural aquece a pedra e a cerâmica envolventes.' },
        ...
        <div ref={imgWrapRef} style={{
          ...
          >
            ...
            <img
              ...
              style={{
                display: 'block', width: '100%', maxHeight: isMobile ? '70vh' : '80vh', objectFit: 'contain',
