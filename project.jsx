...
const ACABAMENTOS_ROOMS = [
  {
    ...
    spots: [
      ...
      { id: 'shower', x: 71, y: 16, label: 'Duche', material: 'BRUMA — Sistema embutido', detail: 'Sistema de duche embutido BRUMA com chuveiro de parede e douchette. Válvulas ocultas mantêm a parede contínua.', url: 'https://www.bruma.pt/assets/INFO/new/1673602CR_ficha.pdf' },
      ...
      { id: 'faucet', x: 28, y: 48, label: 'Torneira', material: 'BRUMA — Aço inox escovado', detail: 'Torneira monocomando de lavatório BRUMA em aço inox escovado anti-impressões digitais. Design minimalista com controlo de temperatura integrado.', url: 'https://www.bruma.pt/?page=products&prod=4596' },
      { id: 'basin', x: 30, y: 55, label: 'Lavatório', material: 'ITALBOX — Solid surface', detail: 'Lavatório ITALBOX Quadratum em solid surface. Geometria precisa, quente ao toque, não poroso e fácil de manter.', url: 'https://italbox.pt/pt/produtos/lavatorios/solid-surface-1/bancada-lavatorio-quadratum-ss' },
      { id: 'vanity', x: 25, y: 66, label: 'Móvel', material: 'ITALBOX — Folheado a carvalho', detail: 'Móvel de lavatório suspenso ITALBOX em folheado de carvalho. O veio natural aquece a pedra e a cerâmica envolventes.' },
      { id: 'wc', x: 55, y: 75, label: 'Sanita', material: 'GEBERIT — Suspensa', detail: 'Conjunto sanita suspensa GEBERIT com autoclismo oculto e comando de descarga. O chão fica livre para fácil limpeza.', url: 'https://catalog.geberit.pt/pt-PT/product/PRO_1511968' },
      { id: 'tile', x: 50, y: 94, label: 'Cerâmico', material: 'MARAZZI — Grande Concrete Look White', detail: 'Cerâmico MARAZZI Grande Concrete Look White em paredes e pavimento. Placas de grande formato que minimizam juntas.', url: 'https://www.marazzitile.co.uk/collections/grande-concrete-look-collections/' },
    ],
  },
  {
    id: 'cozinha',
